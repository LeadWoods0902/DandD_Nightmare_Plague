...
As an action, the Genasi can target a creature within 60ft, dealing ((30+10(E-2))//10)d8 electrical damage. The attack chains to each target within 30+10(E-2) feet of the first, dealing ((30+10(E-2))//10-x)d8 lightning damage to each target where x is the number of 10ft intervals between the first and next target. 
