...
As an action, the Genasi can target a creature within 60ft, dealing 4d8 electrical damage. The attack chains to each target within 40ft of the first, dealing (4-x)d8 damage to each target where x is the number of 10ft intervals between the first and next target.
